...
- Track tiles: `track1.png` … `track7.png` (wide Super Sprint lane geometry; Kenney-inspired asphalt generated by `scripts/generate-track-tiles.py`)
- Terrain flora: `trees/<terrain>/…` (Kenney CC0 derivatives)
- UI: `icon.png`, splash, generated track previews
